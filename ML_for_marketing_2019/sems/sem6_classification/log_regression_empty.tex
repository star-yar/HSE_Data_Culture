...
Если говорить без прекрас, это и есть наша функция потерь.  От неё нам нужно найти производную. Давайте подготовимся. Делай раз, найдём производную $logloss$ по$ \hat p$: 
...
По-другому это можно записать как $\hat p \cdot (1 - \hat p)$.  \textbf{Всё.} Давайте искать полную производную. Начнём изнутри:

$$
\left( e^{-\beta \cdot x} \right) '_{\beta} =   e^{-\beta \cdot x} \cdot (- \beta)
$$
